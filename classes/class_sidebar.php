...
class Sidebar extends Widget{
    ...
    */
    ...
    protected function setMoneyBar(){
        ...
        $this->moneyBar->add(new Comment("현재 보유금액: {$mysidia->user->money} {$mysidia->settings->cost}"));
    ...
    protected function setLinksBar(){
		...
		$linkTitle = new Comment("{$mysidia->user->username}의 퀵슬롯:");
		$linkTitle->setBold();
    ...
    protected function setWolBar(){
        ...
        $this->wolBar->setText("현재 회원 {$online}명, 손님 {$offline}명 접속중");
