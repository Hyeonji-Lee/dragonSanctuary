...
class Footer extends Widget{
    ...
    */
    ...
    protected function setCredits(){
        ...
        $this->credits->add(new Comment("게임물관리위원회 1AA-1604-006182 민원에 의해 <strong>졸업작품으로 학교 제출하는 경우 등급분류를 받지 않습니다</strong>."));
        $this->credits->add(new Comment("본 게임은 제출 이외의 목적이 없습니다."));
