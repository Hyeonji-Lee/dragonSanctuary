...
class LevelupController extends AppController{
	...
	public function click(){
    	//echo "<script>alert('!알림 \\n (click)디버깅 작업 중...');</script>";
		$mysidia = Registry::get("mysidia");
		$date = new DateTime;
	...
	/*public function siggy(){
        ...
        $siggyimage = imagecreatefrompng($image);
        imagepng($siggyimage);
    ...
    /*public function siggy(){
	    ...
	    if(function_exists('imagegif') and $usegd == "yes" and $imagemime == "image/gif"){
            ...
            /*$str1 = "이름: ".$this->adopt->getName();
            $str2 = "오너: ".$this->adopt->getOwner();
	        $str3 = "이 드래곤을 클릭하여 돌봐주세요!";
	        $str4 = "더 많은 드래곤들이 있는 곳:";
