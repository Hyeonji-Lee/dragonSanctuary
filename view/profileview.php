...
class ProfileView extends View{
	...
	public function view(){
        ...
        $tabsList->put(new String("방명록"), new String("visitormessage"));
        $tabsList->put(new String("프로필"), new String("aboutme"));
        $tabsList->put(new String("보유 드래곤"), new String("adopts"));
        //$tabsList->put(new String("Friends"), new String("friends"));
        $tabsList->put(new String("연락처"), new String("contactinfo"));
	    ...
	    elseif(!$mysidia->user->status->canvm) $document->addLangvar($this->lang->VM_banned);
			...
			$vmForm->add(new Button("덧글입력", "submit", "submit"));
