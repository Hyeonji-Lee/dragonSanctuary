...
class FriendsView extends View{
	...
	public function request(){
        ...
        $document->addLangvar("<br>친구요청을 보냈습니다. 이제, {$friend}님의 응답을 기다려보세요.");
        //"<br>Congrats! You have successfully sent a friendrequest to {$friend}, you may now wait for his/her response."
	}
